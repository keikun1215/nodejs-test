...
client.on('messageCreate', async message => {
  ...
  if("1031166936102486016" == message.channel.id) return
...
function cmems () {
  ...
  client.channels.cache.get("1050991912263372830").setName(`認証人数: ${g.members.cache.map(m=>m._roles.includes("1028605548238733312")).filter(b=>b).length}`)
}
